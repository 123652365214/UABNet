...
from methods.zoomnext.zoomnext import PvtV2B2_ZoomNeXt                      #your net
...
def hook_func(module, input, output, medium_results_path='/home/fy/pythonProject/SARNet-main/image_results'): ## results path
...
def main(exp_name, net, pretrained_model_path, modules_for_plot, scale ): 
    to_test = OrderedDict([
        ('CAMO', '/home/fy/pythonProject/ZoomNeXt_main/data/TestDataset/CAMO'),
...
if __name__ == '__main__':
    ...
    predict_model('PvtV2B2_ZoomNeXt','/home/fy/pythonProject/SARNet-main/pth_weighted/state_final.pth', PvtV2B2_ZoomNeXt())       ###checkpoints  pth